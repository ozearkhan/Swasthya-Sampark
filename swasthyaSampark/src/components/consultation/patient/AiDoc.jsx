  ...
  let handlePrompt = async () => {
    try {
      let promptValue =
        ...
        customValue +
        ". Give me a possible Diagnosis and Treatment Plan for now later i will consult a doctor. Dont provide sentences that you are an AI and cant help it , you can provide over the counter medications which does not need a doctor.";
